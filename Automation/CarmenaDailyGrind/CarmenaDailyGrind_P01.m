...
current_path = strcat(START_DIR_ROOT,'\','2P_temp'); % get all data in 'temp data'
...
if exist(destined_path) ==0;
mkdir(destined_path);
else
    disp('destination path already exists...');
end
